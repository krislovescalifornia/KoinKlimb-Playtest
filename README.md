...
## Latest: v0.26.0 - Player Specials and Powerup Polish

Download the Windows ZIP from the [v0.26.0 release page](https://github.com/krislovescalifornia/KoinKlimb-Playtest/releases/tag/v0.26.0), extract the entire folder, and run `King of the Koin.exe`.

All players in a match must use the exact same displayed version: **0.26.0**.
...
Expected SHA-256 for `King-of-the-Koin-v0.26.0-windows-x86_64.zip`:

```text
2C3079E1F5A1B69F8CC2ACC8C822EE32FDF51B297CC3EBE08A284BA82E0CB549
```

PowerShell verification:

```powershell
(Get-FileHash .\King-of-the-Koin-v0.26.0-windows-x86_64.zip -Algorithm SHA256).Hash
```
