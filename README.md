...
## Latest: v0.29.0 - Diverse Klimber Profiles

Download the Windows ZIP from the [v0.29.0 release page](https://github.com/krislovescalifornia/KoinKlimb-Playtest/releases/tag/v0.29.0), extract the entire folder, and run `King of the Koin.exe`.

All players in a match must use the exact same displayed version: **0.29.0**.
...
Expected SHA-256 for `King-of-the-Koin-v0.29.0-windows-x86_64.zip`:

```text
A86021F5708460D34CE3B4528B04904F05ECC8888EC5C2B8F2590E715005C809
```

PowerShell verification:

```powershell
(Get-FileHash .\King-of-the-Koin-v0.29.0-windows-x86_64.zip -Algorithm SHA256).Hash
```
