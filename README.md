...
## Latest: v0.21.1 - Carrier Stability Fixes

Download the Windows ZIP from the [v0.21.1 release page](https://github.com/krislovescalifornia/KoinKlimb-Playtest/releases/tag/v0.21.1), extract the entire folder, and run `King of the Koin.exe`.

All players in a match must use the exact same displayed version: **0.21.1**.
...
Expected SHA-256 for `King-of-the-Koin-v0.21.1-windows-x86_64.zip`:

```text
FEC33D2E361724837F5D621B25B8EAD92BB803D1C738219E34C0A3A74FAF8E17
```

PowerShell verification:

```powershell
(Get-FileHash .\King-of-the-Koin-v0.21.1-windows-x86_64.zip -Algorithm SHA256).Hash
```
