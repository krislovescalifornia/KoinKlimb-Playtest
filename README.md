...
## Latest: v0.28.0 - Character Outfit Expansion

Download the Windows ZIP from the [v0.28.0 release page](https://github.com/krislovescalifornia/KoinKlimb-Playtest/releases/tag/v0.28.0), extract the entire folder, and run `King of the Koin.exe`.

All players in a match must use the exact same displayed version: **0.28.0**.
...
Expected SHA-256 for `King-of-the-Koin-v0.28.0-windows-x86_64.zip`:

```text
775BE4898F084988C3AFB6967CE8A72146A78FFE4FD98710F0BFD1167FF4EF22
```

PowerShell verification:

```powershell
(Get-FileHash .\King-of-the-Koin-v0.28.0-windows-x86_64.zip -Algorithm SHA256).Hash
```
