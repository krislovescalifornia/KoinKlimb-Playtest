...
## Latest: v0.13.0 - Lively Online Lobbies

Download the Windows ZIP from the [v0.13.0 release page](https://github.com/krislovescalifornia/KoinKlimb-Playtest/releases/tag/v0.13.0), extract the entire folder, and run `King of the Koin.exe`.

All players in a match must use the exact same displayed version: **0.13.0**.
...
Expected SHA-256 for `King-of-the-Koin-v0.13.0-windows-x86_64.zip`:

```text
6D7A66E1BFD4DEE95FF42E1217820F8A2B4DC67EACFFBF1B9174CB35B2A47632
```

PowerShell verification:

```powershell
(Get-FileHash .\King-of-the-Koin-v0.13.0-windows-x86_64.zip -Algorithm SHA256).Hash
```
