...
## Latest: v0.23.0 - Concussion Pulse Combat

Download the Windows ZIP from the [v0.23.0 release page](https://github.com/krislovescalifornia/KoinKlimb-Playtest/releases/tag/v0.23.0), extract the entire folder, and run `King of the Koin.exe`.

All players in a match must use the exact same displayed version: **0.23.0**.
...
Expected SHA-256 for `King-of-the-Koin-v0.23.0-windows-x86_64.zip`:

```text
CA0A62A8CAF7C9D9C88C4330247CFFABA8A9F664B91271773D48481D6CF3D290
```

PowerShell verification:

```powershell
(Get-FileHash .\King-of-the-Koin-v0.23.0-windows-x86_64.zip -Algorithm SHA256).Hash
```
