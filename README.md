...
## Latest: v0.18.0 - Monumental Multipath Mountain

Download the Windows ZIP from the [v0.18.0 release page](https://github.com/krislovescalifornia/KoinKlimb-Playtest/releases/tag/v0.18.0), extract the entire folder, and run `King of the Koin.exe`.

All players in a match must use the exact same displayed version: **0.18.0**.
...
Expected SHA-256 for `King-of-the-Koin-v0.18.0-windows-x86_64.zip`:

```text
43B2F5E85F733F50BEDA6582C948F232D74F4D9F2017CA38FA1D2995ACC609CC
```

PowerShell verification:

```powershell
(Get-FileHash .\King-of-the-Koin-v0.18.0-windows-x86_64.zip -Algorithm SHA256).Hash
```
