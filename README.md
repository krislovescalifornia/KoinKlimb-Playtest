...
## Latest: v0.14.0 - Royal Menu Overhaul

Download the Windows ZIP from the [v0.14.0 release page](https://github.com/krislovescalifornia/KoinKlimb-Playtest/releases/tag/v0.14.0), extract the entire folder, and run `King of the Koin.exe`.

All players in a match must use the exact same displayed version: **0.14.0**.
...
Expected SHA-256 for `King-of-the-Koin-v0.14.0-windows-x86_64.zip`:

```text
487FE7DC8124AAB9EDDE5C5934F6F5B6B7DAB924066583DF980AEE795A226891
```

PowerShell verification:

```powershell
(Get-FileHash .\King-of-the-Koin-v0.14.0-windows-x86_64.zip -Algorithm SHA256).Hash
```
