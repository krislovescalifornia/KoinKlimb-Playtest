...
## Latest: v0.34.5 - Clean Fast Startup Shutdown

Download the Windows ZIP from the [v0.34.5 release page](https://github.com/krislovescalifornia/KoinKlimb-Playtest/releases/tag/v0.34.5), extract the entire folder, and run `King of the Koin.exe`.

All players in a match must use the exact same displayed version: **0.34.5**.
...
Expected SHA-256 for `King-of-the-Koin-v0.34.5-windows-x86_64.zip`:

```text
F4AA32EDB03CFCD4A485857C83E68E833DAF948347E9A2DA2ED3C09C82E9519E
```

PowerShell verification:

```powershell
(Get-FileHash .\King-of-the-Koin-v0.34.5-windows-x86_64.zip -Algorithm SHA256).Hash
```
