...
## Latest: v0.34.1 - Faster Primetime Checks

Download the Windows ZIP from the [v0.34.1 release page](https://github.com/krislovescalifornia/KoinKlimb-Playtest/releases/tag/v0.34.1), extract the entire folder, and run `King of the Koin.exe`.

All players in a match must use the exact same displayed version: **0.34.1**.
...
Expected SHA-256 for `King-of-the-Koin-v0.34.1-windows-x86_64.zip`:

```text
47EAFEF7DAF174BACCA473E039F337A19636E60E30F34C384459F1C8F6361391
```

PowerShell verification:

```powershell
(Get-FileHash .\King-of-the-Koin-v0.34.1-windows-x86_64.zip -Algorithm SHA256).Hash
```
