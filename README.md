...
## Latest: v0.21.0 - Koin Control Rebalance

Download the Windows ZIP from the [v0.21.0 release page](https://github.com/krislovescalifornia/KoinKlimb-Playtest/releases/tag/v0.21.0), extract the entire folder, and run `King of the Koin.exe`.

All players in a match must use the exact same displayed version: **0.21.0**.
...
Expected SHA-256 for `King-of-the-Koin-v0.21.0-windows-x86_64.zip`:

```text
7835C81EF4BAF5AAD1D1E6797045374D8EFA120F946B81A8E5A74AB759FCDCA9
```

PowerShell verification:

```powershell
(Get-FileHash .\King-of-the-Koin-v0.21.0-windows-x86_64.zip -Algorithm SHA256).Hash
```
