...
## Latest: v0.15.0 - Strategic Powerups

Download the Windows ZIP from the [v0.15.0 release page](https://github.com/krislovescalifornia/KoinKlimb-Playtest/releases/tag/v0.15.0), extract the entire folder, and run `King of the Koin.exe`.

All players in a match must use the exact same displayed version: **0.15.0**.
...
Expected SHA-256 for `King-of-the-Koin-v0.15.0-windows-x86_64.zip`:

```text
3E1204A08D91E0437202A65D6CD9DE30CB0842279739D9CA60B486CD96F64652
```

PowerShell verification:

```powershell
(Get-FileHash .\King-of-the-Koin-v0.15.0-windows-x86_64.zip -Algorithm SHA256).Hash
```
